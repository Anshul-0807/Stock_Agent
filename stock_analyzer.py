...
def search_stock_news(symbol: str) -> str:
    ...
    try:
        with DDGS() as ddgs:
            ...
            search_terms = [
                f"{company_name} stock news last 7 days",
...
class StockAnalyzer:
    def __init__(self):
        ...
        self.news_search_tool = Tool(
            ...
            description="Searches for recent news about a stock or company"
        )
        ...
        self.research_analyst = Agent(
            ...
            goal='Gather and analyze market news and sentiment',
            backstory="""You are a thorough research analyst who gathers and analyzes 
            market news, sentiment, and trends to provide context to investment decisions.""",
...
"""
        ...
        if "News Analysis" in analysis_types:
            news_analysis = Task(
                ...
                Focus on the most recent and significant news that could impact the stock price.""",
