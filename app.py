...
if 'analyzer' not in st.session_state:
    if validate_api_keys():
        st.session_state.analyzer = StockAnalyzer("AAPL")  # Initialize with default symbol
    else:
        st.stop()
...
# Update analyzer with new symbol if it changes
if symbol != st.session_state.analyzer.symbol:
    st.session_state.analyzer = StockAnalyzer(symbol)
